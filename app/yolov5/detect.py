...
def run(weights=ROOT / 'yolov5s.pt',  # model.pt path(s)
    ...
    result = cv2.VideoWriter('static/video/out_video.mp4',
...
def parse_opt(weight, source, source_type):
    ...
    parser.add_argument('--source_type', default=source_type)
...
def detect_object(source, source_type):
    print(os.getcwd())
    opt = parse_opt('yolov5/best.pt', source, source_type)
    main(opt)
