...
def model_summary_cv2():
    json_file = open('../training_models_and weight_files/recognition-cnn/roadsigns1.json', 'r')
    rs = json_file.read()
    json_file.close()
    loaded_model = model_from_json(rs)
    loaded_model.load_weights("../training_models_and weight_files/recognition-cnn/roadsigns1.h5")
...
def class_distribution():
    ...
    c = {}
    pdir = 'training_models/recognition-cnn/dataset/train/'
